...
3 could always use more documentation, whether as part of the
official 3 docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `3` for local development.

1. Fork the `3` repo on GitHub.
...
2. The tests that cover a module called ``pyteller/path/to/a_module.py``
   should be implemented in a separated module called
   ``tests/pyteller/path/to/test_a_module.py``.
...
To run a subset of tests::
    ...
    $ python -m pytest tests.test_pyteller
...
or in command line::
    ...
    pip install 'pyteller>=X.Y.Z.dev'


.. _GitHub issues page: https://github.com/signals-dev/pyteller/issues
.. _Build Status page: https://github.com/signals-dev/pyteller/actions
